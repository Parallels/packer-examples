# Debian base Machines with Packer and Vagrant for Parallels Desktop and Mac with Apple Silicon chip

## Getting Started

This is a automated packer build for Debian. It can create a Vagrant box or just a virtual machine in Parallels Desktop.
...
- `version` - The version of Debian to build. This can be any version that is available for ARM in the [Debian release page](https://cdimage.debian.org/cdimage/release/).
...
- `addons` - A list of addons to install. The following addons are available:
  - `desktop` - Installs the Debian desktop.
