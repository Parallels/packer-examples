Write-Host "Installing Visual Studio Professional 2022..."
$installationName=  "Visual Studio Professional 2022"
choco install vswhere -y
Write-Host "Refreshing the environment path..."
$env:Path = [System.Environment]::GetEnvironmentVariable("Path","Machine") + ";" + [System.Environment]::GetEnvironmentVariable("Path","User")
Write-Host "Downloading Visual Studio Professional 2022 Setup..."
curl https://aka.ms/vs/17/release/vs_Professional.exe -o c:/parallels-tools/vs_professional_2022.exe
Write-Host "Installing Visual Studio Professional 2022..."
cd c:/parallels-tools
.\vs_professional_2022.exe --wait --includeRecommended --add Microsoft.VisualStudio.Workload.CoreEditor --add Microsoft.VisualStudio.Workload.Universal --add Microsoft.VisualStudio.Workload.NativeCrossPlat --quiet
