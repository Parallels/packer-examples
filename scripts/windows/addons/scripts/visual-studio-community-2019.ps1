Write-Host "Installing Visual Studio Community 2019..."
$installationName=  "Visual Studio Community 2019"
choco install vswhere -y
Write-Host "Refreshing the environment path..."
$env:Path = [System.Environment]::GetEnvironmentVariable("Path","Machine") + ";" + [System.Environment]::GetEnvironmentVariable("Path","User")
Write-Host "Downloading Visual Studio Community 2019 Setup..."
curl https://aka.ms/vs/16/release/vs_Community.exe -o c:/parallels-tools/vs_community_2019.exe
Write-Host "Installing Visual Studio Community 2019..."
cd c:/parallels-tools
.\vs_community_2019.exe --wait --includeRecommended --add Microsoft.VisualStudio.Workload.CoreEditor --add Microsoft.VisualStudio.Workload.Universal --add Microsoft.VisualStudio.Workload.NativeCrossPlat --quiet
